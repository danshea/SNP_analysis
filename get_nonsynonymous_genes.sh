...
S11_HIGH='S11-homozygous-variants.snpeff.unique.missense.tsv'
R09_HIGH='R09-homozygous-variants.snpeff.unique.missense.tsv'
# grep out entries that are missense polymorphisms and put them into a new list.
zgrep 'missense_variant' $S11 > $S11_HIGH
zgrep 'missense_variant' $R09 > $R09_HIGH
